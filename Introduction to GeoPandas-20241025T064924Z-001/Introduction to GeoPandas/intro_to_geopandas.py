...
districts = gpd.read_file(r'D:\Learn_Code\Introduction to GeoPandas-20241025T064924Z-001\Introduction to GeoPandas\Shapefiles\districts.shp')
districts.plot(cmap = 'hsv', edgecolor = 'black', column = 'district')

area_of_interest = gpd.read_file(r'D:\Learn_Code\Introduction to GeoPandas-20241025T064924Z-001\Introduction to GeoPandas\Shapefiles\area_of_interest.shp')
area_of_interest.plot()

atms = gpd.read_file(r'D:\Learn_Code\Introduction to GeoPandas-20241025T064924Z-001\Introduction to GeoPandas\Shapefiles\atms.shp')
